                                                        ...
                                                        <div className="wrapper" >
                                                            ...
                                                            <div>
                                                                ...
                                                                <ReactStars
                                                                    ...
                                                                    activeColor="#0073e6"
                                                                />
                                                                {ele.isApproved==0?<p style={{paddingLeft:"60%"}}> <BsFillExclamationTriangleFill color={"#1e90ff"}size={25}/> Pending for approval </p>:(
                                                                    ele.isApproved==1?<p style={{paddingLeft:"60%"}}> <BsCheckCircleFill size={20} color={"green"}/> Approved </p>:
                                                                    <p style={{paddingLeft:"60%"}}> <BsXSquareFill size={20} color={"#ce2029"}/> Request Declined </p>)
                                                                }
                                                                )
